namespace RegxCalc
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			// express
			// 
			this.express.Location = new System.Drawing.Point(17, 22);
			this.express.Name = "express";
			this.express.Size = new System.Drawing.Size(793, 21);
			this.express.TabIndex = 2;
			this.express.Text = "sin(cos(sqrt(2E2-0.5)+0.3))^2+cos(cos(sqrt(2E2-0.5)+0.3))^2+2.3-6.75f";
			// 
			// textBox2
			// 
